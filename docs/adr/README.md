...
| [0005](0005-claims-are-truth-balances-are-a-projection.md)                                   | Claims are the source of truth; balances are a projection                    | Accepted, amended by 0033; amended by 0074 (voucher watermark; the journaled `ChannelConfig`)              |
...
| [0024](0024-peer-wire-claims-sign-the-eip-712-balance-proof.md)                        | Peer claims sign the EIP-712 balance-proof digest                                    | Accepted — amended by #1136; extended by 0074                                                           |
| [0053](0053-a-solana-claim-binds-its-domain-the-way-an-evm-claim-does.md)              | A Solana claim binds its domain, the way an EVM claim already does                   | Accepted — **built** (#1082); the wire change has landed; extended by 0074                              |
| [0059](0059-a-channel-is-derived-from-its-participants.md)                             | A channel is derived from its participants, on both chains, by the same rule         | Accepted — **built** (#1158); the redeploy has not happened; amended by 0074 (client edge)              |
...
| [0070](0070-an-onion-address-is-a-host-not-a-carriage.md)                             | An onion address is a host, not a carriage                                  | Accepted — **built** (#1273), amended in place by #1284 (`.anyone` is a host too); extends 0027; narrows 0004 in one place; decision 4 amended by 0073 |
| [0073](0073-settlement-rpc-may-ride-the-circuit-once-every-wait-on-it-is-bounded.md)  | Settlement RPC may ride the circuit, once every wait on it is bounded       | Accepted — **built** (TOON_Network#167): `rpc_via_socks_proxy` and decision 5's hardening; amends 0070 decision 4; funded circuit run still owed       |
| [0021](0021-vectors-are-normative-prose-is-not.md)                                    | Vectors are normative; prose is not                                         | Accepted — **the tiebreaker for this whole group**; disturbed by 0074 (`schema_version` 6)                                                             |
