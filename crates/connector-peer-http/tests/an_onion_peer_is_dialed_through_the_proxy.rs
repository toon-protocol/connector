...
//! and the app's `handler_url` hold their own clients, neither of which this
//! crate touches. The `handler_url` dials direct; settlement RPC rides the
//! proxy only when its table opts in (ADR 0073, asserted in
